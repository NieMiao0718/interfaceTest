...
if __name__ == '__main__':#我们执行该文件测试一下是否可以正确获取Excel中的值
    ...
    print(readExcel().get_sheet('haishen_create_sale_sku.xlsx'))
    print(readExcel().get_xls('haishen_create_sale_sku.xlsx', 'CreateSaleSku_1101'))
