...
class testCreateServiceSku(unittest.TestCase):
    ...
    def checkResult(self):# 断言
        ...
        if self.case_name == 'create_service_sku_1101':# 如果case_name是login，说明合法，返回的code应该为200
            self.assertEqual(ss['status'], 2000)
        if self.case_name == 'create_service_sku_1082':# 如果case_name是login，说明合法，返回的code应该为200
            self.assertEqual(ss['status'], 2000)
